...
if (isset($_GET['delete_id']) && is_numeric($_GET['delete_id'])) {
    ...
    $stmt = $conn->prepare("DELETE FROM ruins_of_hampi WHERE id = ?");
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $insert_sql = "INSERT INTO ruins_of_hampi (name, email, mobile, date, no_of_players, timeslot_id, txnID) VALUES ('$name', '$email', '$mobile', '$date', '$no_of_players', '$timeslot_id', '$txnID')";
