...
if (isset($_GET['delete_id']) && is_numeric($_GET['delete_id'])) {
    ...
    $stmt = $conn->prepare("DELETE FROM killbill WHERE id = ?");
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $insert_sql = "INSERT INTO killbill (name, email, mobile, date, no_of_players, timeslot_id, txnID) VALUES ('$name', '$email', '$mobile', '$date', '$no_of_players', '$timeslot_id', '$txnID')";
...
$sql = "SELECT * FROM killbill WHERE date BETWEEN '$today' AND '$twoDaysLater'";
