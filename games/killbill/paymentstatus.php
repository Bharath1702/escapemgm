...
if ($responsePayment['success'] && $responsePayment['code'] == "PAYMENT_SUCCESS") {
    ...
    $stmt = $conn->prepare("INSERT INTO killbill (name, email, mobile, date, no_of_players, timeslot_id, txnID) VALUES (?, ?, ?, ?, ?, ?, ?)");
    ...
    try {
        ...
        ";
        $mail->AltBody = 'Booking Unsuccessful for Killbill. Check your email for details.';
